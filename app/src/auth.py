...
def register():
    ...
    if request.method == "POST":
        ...
        date_of_birth = request.form.get("date_of_birth") #added by Sky
        grade = request.form.get("grade") #added by Sky
        email = request.form.get("email")
        password = request.form.get("password")
        ...
        return redirect(url_for("auth.login_post")) #added by Sky
