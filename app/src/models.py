...
class User(UserMixin, db.Model):
    ...
    # grade = db.Column(SQLAlchemyEnum(GradeEnum), nullable=True)
    grade = db.Column(SQLAlchemyEnum(GradeEnum), default=GradeEnum.NA) # changed by Sky
